...
<div class="feed-item">
  <!--<h3 class="feed-item-title">-->
    <?php if ($source_title == "reddit"): ?><img src="/sites/all/themes/femfxmkII/image/reddit.png" /><?php else: ?>
        <?php if ($source_title == "gosugamers"): ?><img src="/sites/all/themes/femfxmkII/image/gosugamers.png" /><?php else: ?>
            <?php if ($source_title == "reddit"): ?><img src="/sites/all/themes/femfxmkII/image/blizzard.png" /><?php else: ?>
                <img src="/sites/all/themes/femfxmkII/image/default.png" />
            <?php endif; ?>
        <?php endif; ?>
    <?php endif; ?>
    <a href="<?php print $feed_url; ?>">
        <?php print $feed_title; ?></a>
